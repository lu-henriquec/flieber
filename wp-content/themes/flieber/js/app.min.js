...
/* harmony import */ var _core_header__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./core/header */ "./src/scripts/core/header.js");
/* harmony import */ var _pages_home__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/home */ "./src/scripts/pages/home.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core */ "./src/scripts/core/index.js");

Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(function Header() {
  console.log("Header");
  var _this = Header;
...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(function Home() {
  var _this = Home;
  ...
  _this.carrosselFeature = function () {
    ...
    var _fundo = "";
    var _fonte = "";
    $(".feature .slider-nav").on("beforeChange", function (event, slick, currentSlide) {
      ...
      setTimeout(function () {
        ...
        $("section.feature").css("background", "linear-gradient(to right, " + _fundo + ")");
  ...
  _this.carrosselVideos = function () {
  ...
  _this.carrosselHowWeDoIt = function () {
  ...
  _this.carrosselDepoiment = function () {
  ...
  _this.carrosselTransports = function () {
    ...
    $(".transports .slider-nav").slick({
      ...
      customPaging: function customPaging(slider, i) {
        return '<button class="tab">' + $(slider.$slides[i]).find("h3").text() + "</button>";
      },
      arrows: false,
      fade: true,
      centerMode: false,
  ...
  _this.tabs = function () {
    $(".blog__tabs a").on("click", function () {
      ...
      $(".blog__content[data-anchor=".concat(content, "]")).addClass("active");
    });
  };
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/flieber/wp-content/themes/flieber/src/scripts/app.js */"./src/scripts/app.js");
